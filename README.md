...
- `/metrics` está aberto por padrão; ajuste envs adicionais conforme necessidade (não requer auth).
...
- Teste: `http://localhost:8000/health` e `/docs`; métricas em `http://localhost:8000/metrics`

...
- Métricas Prometheus expostas em `:9000/metrics` (ver abaixo para instrumentação).

## Deploy via Docker
- Build: `docker build -t lstm-api .`
- Run: `docker run --rm -p 8000:8000 -p 9000:9000 lstm-api`
- Teste: `http://localhost:8000/health` e `/docs`; métricas em `http://localhost:9000/metrics`
